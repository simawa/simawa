	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="box box-solid">
			<div class="box-header with-border">
				...
				<i class="fa fa-user"></i> Tambah Kemahasiswaan
				</button>
			</div>
			<div class="box-body">
					...
					<table class="table table-bordered" id="data-tables">
						...
						<tbody>
							...
							<tr>
								...
								<td><?= $nama;?></td>
								<td>
									<button class="btn btn-success" type="button" data-toggle="modal" data-placement="top" title="Edit" data-target="#modal-edit" onclick="edit_kemahasiswaan('<?= $niy;?>','<?= $nama;?>','<?= $jenis_kelamin;?>','<?= $password;?>','<?= $status;?>','<?= $telp;?>')"><i class="fa fa-pencil"></i></button>
									<?= '
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/kemahasiswaan/add')?>">
					<div class="box-header">
						<div class="box-footer bg-blue"
							<h4 class="pull-left" style="color: #fff;"><i class="fa fa-institution"></i> Tambah Kemahasiswaan</h4>
						</div>
					</div>
					<div class="box-body">
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-group">
							<label for="" class="col-md-2 col-sm-2 col-xs-2 control-label">Niy</label>
							<div class="col-md-10 col-sm-10 col-xs-10">
								<input type="text" class="form-control" name="niy" required="">
							</div>
						</div>
						<div class="form-group">
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/kemahasiswaan/edit')?>">
					<div class="box-header">
						<div class="box-footer bg-blue">
							<h4 class="pull-left" style="color: #fff;"><i class="fa fa-user"></i> Edit Kemahasiswaan</h4>
						</div>
					</div>
					<div class="box-body">
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-group">
							<label for="" class="col-md-2 col-sm-2 col-xs-2 control-label">Niy</label>
							<div class="col-md-10 col-sm-10 col-xs-10">
								<input type="text" class="form-control" id="edit_niy" name="niy" readonly="">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-md-2 col-sm-2 col-xs-2 control-label">Nama</label>
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header bg-blue">
				...
				<h4 class="modal-title"><i class="fa fa-user"></i> Detail Kemahasiswaan</h4>
			</div>
...
<div class="modal modal-default fade" id="modal-hapus">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="post">
				<div class="modal-body">
					<input type="hidden" name="hapus_niy" id="hapus_niy">
...
// modal bootstrap tidak akan jalan
		$("#IsiModal").html('<table class="table table-responsive table-striped"><tbody><tr><th>Niy</th><td> : '+datanya[0]+'</td></tr><tr><th>Nama</th><td> : '+datanya[1]+'</td></tr><tr><th>Jenis Kelamin</th><td> : '+datanya[2]+'</td></tr><tr><th>Password</th><td> : '+datanya[3]+'</td></tr><tr><th>Status</th><td> : '+datanya[4]+'</td></tr><tr><th>Telp</th><td> : '+datanya[5]+'</td></tr></tbody></table>');
		});
	
	});
</script>
<script>
	function edit_kemahasiswaan(a,b,c,d,e,f) {
		$('#edit_niy').val(a);
		$('#edit_nama').val(b);
		$('#edit_kelamin').val(c);
		$('#edit_password').val(d);
...
<script>
	function hapus_kemahasiswaan(a) {
		$('#hapus_niy').val(a);
	}
</script>