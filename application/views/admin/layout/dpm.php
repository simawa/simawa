	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="box box-solid">
			<div class="box-header with-border">
				...
				<i class="fa fa-user"></i> Tambah Dpm
				</button>
			</div>
			<div class="box-body">
					...
					<table class="table table-bordered" id="data-tables">
						...
						<tbody>
							...
							<tr>
								...
								<td><?= $jabatan;?></td>
								<td>
									<button class="btn btn-success" type="button" data-toggle="modal" data-placement="top" title="Edit" data-target="#modal-edit" onclick="edit_pengguna('<?= $nim;?>','<?= $nama;?>','<?= $jenis_kelamin;?>','<?= $jabatan;?>','<?= $password;?>','<?= $status;?>','<?= $telp;?>')"><i class="fa fa-pencil"></i></button>
									<?= '
									<button type="button" data-toggle="modal" data-placement="top" title="Detail" data-target="#ModalDetail" id="'.$nim.'|'.$nama.'|'.$jenis_kelamin.'|'.$jabatan.'|'.$password.'|'.$hasil.'|'.$telp.'|" class="btn btn-primary detail-pengguna"><i class="fa fa-info"></i></button>
									';?>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/dpm/add')?>">
					<div class="box-header">
						<div class="box-footer bg-blue"
							<h4 class="pull-left" style="color: #fff;"><i class="fa fa-user"></i> Tambah Dpm</h4>
						</div>
					</div>
					<div class="box-body">
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/dpm/edit')?>">
					<div class="box-header">
						<div class="box-footer bg-blue">
							<h4 class="pull-left" style="color: #fff;"><i class="fa fa-user"></i> Edit Dpm</h4>
						</div>
					</div>
					<div class="box-body">
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						...
						<div class="form-group">
							<label for="" class="col-md-2 col-sm-2 col-xs-2 control-label">Telp</label>
							<div class="col-md-10 col-sm-10 col-xs-10">
								<input type="text" class="form-control" name="edit_telp" id="edit_telp" required="">
							</div>
						</div>
					</div>
					<div class="box-footer">
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header bg-blue">
				...
				<h4 class="modal-title"><i class="fa fa-user"></i> Detail Dpm</h4>
			</div>
