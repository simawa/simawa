	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="box box-solid">
			<div class="box-header with-border">
				...
				<i class="fa fa-map-marker"></i> Tambah Tempat
				</button>
			</div>
			<div class="box-body">
					...
					<table class="table table-bordered" id="data-tables">
						...
						<tbody>
							...
							<tr>
								...
								<td><?= $nama;?></td>
								<td>
									<button class="btn btn-success" type="button" data-toggle="modal" data-placement="top" title="Edit" data-target="#modal-edit" onclick="edit_tempat('<?= $id;?>','<?= $nama;?>')"><i class="fa fa-pencil"></i></button>
									<?= '
									<button type="button" data-toggle="modal" data-placement="top" title="Detail" data-target="#ModalDetail" id="'.$id.'|'.$nama.'" class="btn btn-primary detail-tempat"><i class="fa fa-info"></i></button>
									';?>
									<button class="btn btn-danger" type="button" data-toggle="modal" data-placement="top" title="Hapus" data-target="#modal-hapus" onclick="hapus_tempat('<?= $id?>')" ><i class="fa fa-trash"></i></button>
								</td>
							</tr>
							<?php
							}
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/tempat/add')?>">
					<div class="box-header">
						<div class="box-footer bg-blue"
							<h4 class="pull-left" style="color: #fff;"><i class="fa fa-map-marker"></i> Tambah Tempat</h4>
						</div>
					</div>
					<div class="box-body">
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/tempat/edit')?>">
					<div class="box-header">
						<div class="box-footer bg-blue">
							<h4 class="pull-left" style="color: #fff;"><i class="fa fa-map-marker"></i> Edit Tempat</h4>
						</div>
					</div>
					<div class="box-body">
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header bg-blue">
				...
				<h4 class="modal-title"><i class="fa fa-map-marker"></i> Detail Tempat</h4>
			</div>
		...
		<div class="modal-content">
			<form method="post">
				...
				<div class="modal-footer bg-blue">
					<div class="btn-group btn-group-sm pull-right">
						<button id="btn_hapus" name="btn_hapus" formaction="<?= base_url('admin/tempat/delete'); ?>" type="submit" class="btn btn-success ajax-loader">
						<i class="fa fa-check"></i> Simpan
						</button>
						<button data-dismiss="modal" type="button" class="btn btn-danger" aria-label="Close">
						<i class="fa fa-times"></i> Batal
...
$(document).ready(function() {
		...
		$(".detail-tempat").on("click", function(){
